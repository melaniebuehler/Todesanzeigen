...
\begin{enumerate}
\item Trauerspruch von Romano Guardini
\label{sec-1-2-1-2-1}
...
\item Trauerspruch von Papst Johannes XXIII
\label{sec-1-2-1-2-4}
...
\item Trauersprüche von Antoine de Saint-Exupéry
\label{sec-1-2-1-3-4}
...
\item Trauersprüche von Arthur Schopenhauer
\label{sec-1-2-1-3-5}
